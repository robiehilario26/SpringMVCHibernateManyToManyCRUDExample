...
public class AppController {
	...
	/**
	 * This method will list all existing users in Json format.
	 */
	@RequestMapping(value = {"/listJson" }, method = RequestMethod.GET)
	@ResponseBody
	public List<User> listUsersJson(ModelMap model) {
	...
	public String saveUser(@Valid User user, BindingResult result,
		...
		if(!userService.isUserSSOUnique(user.getId(), user.getUsernameId())){
			FieldError ssoError =new FieldError("user","usernameId",messageSource.getMessage("non.unique.usernameId", new String[]{user.getUsernameId()}, Locale.getDefault()));
